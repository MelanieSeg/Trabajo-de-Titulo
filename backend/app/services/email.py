...
def send_password_reset_email(recipient_email: str, reset_token: str, frontend_url: str = None) -> bool:
    """
    Enviar email de restablecimiento de contraseña con enlace de reset.

    Args:
        recipient_email: Dirección de email a la que enviar el enlace de reset
        reset_token: Token de restablecimiento de contraseña
        frontend_url: URL del frontend para el enlace de reset (usa configuración si es None)

    Returns:
        True si el email se envió exitosamente, False en otro caso
    """
    try:
        # Usar URL proporcionada u obtener de configuración
        ...
        # Modo de desarrollo: solo registrar el email
        ...
        # Modo de producción: enviar email vía SMTP
        ...
        # En desarrollo, aún devolver True para que las pruebas no fallen
        if settings.app_env == "development":
            return True
        return False
...
def send_verification_email(recipient_email: str, verification_token: str, frontend_url: str = None) -> bool:
    ...
    Args:
        recipient_email: Dirección de email a la que enviar el enlace de verificación
        verification_token: Token de verificación de email
        frontend_url: URL del frontend para el enlace de verificación (usa configuración si es None)
